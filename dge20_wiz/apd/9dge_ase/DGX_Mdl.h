...
enum EDGX_MDL
{
	...
	DGXM_WORLD_MATRIX			= 0x001003,
	DGXM_WORLD_MATRIX_POINTER	= 0x001004,

	DGXM_LOOP_SECTION		= 0x001005,		// Animation Loop Section
	DGXM_FRAME_INDEX		= 0x001011,
	DGXM_FRAME_INDEX_ABSOLUTE=0x001012,
};
