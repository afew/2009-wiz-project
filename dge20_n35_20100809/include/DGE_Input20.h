...
//
// DGE Input 2.0: Analog Joystick, Touch Screen, Button.
//
////////////////////////////////////////////////////////////////////////////////
...
#ifndef _DGE_Input20_H_
#define _DGE_Input20_H_
...
int DGE_InputOpen20(void*	hWnd);				// Input 장치 사용 초기화. hWnd는 MS 윈도우에만 필요
int DGE_InputClose20();						// Input 장치 사용 해제

int DGE_InputReadAjs20(DGE_INPUT_AJS* ajs);	// 2차원 x,y 반환
int DGE_InputReadTsb20(DGE_INPUT_TS* ts);		// Touch Screen 장치의 데이터 획득(st !=0 Event true, Screen X position, Screen Y position)
int DGE_InputReadKey20(PKEYMAP p);			// Keypad의 데이터 획득(unsigned char 32개 이상: 최소 32byte)
