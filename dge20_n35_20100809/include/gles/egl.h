...
extern "C" {
	...
	extern EGLDisplay  eglGetDisplay           (NativeDisplayType displayID);
	extern EGLBoolean  eglInitialize           (EGLDisplay dpy, EGLint* major, EGLint* minor);
	extern EGLBoolean  eglTerminate            (NativeDisplayType displayID, EGLDisplay dpy);
	...
	extern EGLSurface  eglCreateWindowSurface  (EGLDisplay dpy, EGLConfig config, NativeWindowType win, const EGLint* attrib_list);
	extern EGLSurface  eglCreatePbufferSurface (EGLDisplay dpy, EGLConfig config, const EGLint* attrib_list);
	extern EGLSurface  eglCreatePixmapSurface  (EGLDisplay dpy, EGLConfig config, NativePixmapType pixmap, const EGLint* attrib_list);
	...
	extern EGLContext  eglCreateContext        (EGLDisplay dpy, EGLConfig config, EGLContext share_list, const EGLint* attrib_list);
	...
	extern EGLBoolean  eglCopyBuffers          (EGLDisplay dpy, EGLSurface surface, NativePixmapType target);
